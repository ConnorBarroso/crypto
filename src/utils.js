...
export const get = async (type, data = {}) => {
  const urls = {
    market: `https://api.coingecko.com/api/v3/coins/markets?vs_currency=${data?.currency?.string}&order=${data.sortBy}_${data.order}&per_page=50&page=${data.page}&sparkline=true&price_change_percentage=1h%2C24h%2C7d`,
